...
team's main GitHub repository. Submit your UI Mockups and UML diagram by e-mail. Make sure your GitHub is updated with your User Stories (using Issues) before the deadline. If you are using a different project management tool, make sure your TA has access.
